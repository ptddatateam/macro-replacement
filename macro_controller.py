...
def main(year_of_report, output_path):
    ...
    mode = 'transits'
    if mode == 'transits':
        transits.main(year1, year2, year_of_report, output_path)
...
if __name__ == "__main__":
    main(2017, r'I:\Public_Transportation\Data_Team\PT_Summary\PythonFiles')